...
def generate_shield_materials():
    textures_abs_path = os.path.abspath("../cv/textures")
    res = ''
    for i in range(54):
        res += f"""\t\t<texture name="texture_block{i}_left_shield" type="cube" fileright="{textures_abs_path}/texture_block{i}_left_shield.png"/>
            <material name="mat_block{i}_left_shield" texture="texture_block{i}_left_shield"/>
            <texture name="texture_block{i}_right_shield" type="cube" fileleft="{textures_abs_path}/texture_block{i}_right_shield.png"/>
...
def generate_scene_with_cali(scaler, cali_pos, shield_pose, cali_fl: bool):
    ...
    textures_abs_path = os.path.abspath("../cv/textures")
    res_textures_abs_path = os.path.abspath("../resources/textures")
    ...
    <mujoco>
        ...
        <asset>
            <texture name="tex_floor_tag" type="cube" filefront="{textures_abs_path}/floor_tag.png"/>
            <material name="mat_floor_tag" texture="tex_floor_tag"/>
            <texture name="tex_shield_front" type="cube" fileright="{textures_abs_path}/shield_right.png"/>
            <material name="mat_shield_front" texture="tex_shield_front"/>
            <texture name="tex_shield_back" type="cube" fileleft="{textures_abs_path}/shield_left.png"/>
            <material name="mat_shield_back" texture="tex_shield_back"/>
            <texture name="tex_block_top" type="cube" fileup="{textures_abs_path}/top.png" filedown="{textures_abs_path}/top.png"/>
            <material name="mat_block_top" texture="tex_block_top"/>
            <texture name="tex_cali" type="cube" fileright="{res_textures_abs_path}/cali_tag.png"/>
...
if __name__ == '__main__':
    ...
    # get corrections
    corrections = read_corrections('../data/corrections.json')
