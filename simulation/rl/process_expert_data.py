...
if __name__ == "__main__":
    ...
    # folder = '/home/bch_svt/cartpole/simulation/rl/expert_data/real/raw/*with_ids*'
    ...
    # folder = '/home/bch_svt/cartpole/simulation/rl/expert_data/real/raw/*10_blocks*'
    # fnames = glob.glob(folder)
    #
    # combined_data_with_ids = combine_expert_data(fnames, False)
    #
    ...
    # fnames = ['/home/bch_svt/cartpole/simulation/rl/expert_data/real/without_ids/combined_expert_data_29-08-2020_11:08:26.npz']
    #
    # expert_data = open_expert_data(fnames)
    #
    # expert_data['obs'] = expert_data['obs'][:, :-2]
    #
    # print(f"Expert data obs: {expert_data['obs'][0]}")
    #
    ...
    #     return -1
    #
    # print(f"Keys: {expert_data.keys()}")
    #
    # episode_rewards = []
    # j = 0
    # for i in range(len(expert_data['obs'])):
    #     if expert_data['episode_starts'][0] == 1:
    #         episode_rewards.append(expert_data['episode_returns'][j])
    #     else:
    #         episode_rewards.append(0.0)
    #
    # while find_such_row(expert_data['obs'], expert_data['actions']) != -1:
    #     i = find_such_row(expert_data['obs'], expert_data['actions'])
    #     expert_data['obs'] = np.delete(expert_data['obs'], i, 0)
    #     expert_data['actions'] = np.delete(expert_data['actions'], i, 0)
    #     expert_data['rewards'] = np.delete(expert_data['rewards'], i, 0)
    #     print(f"Episode starts: {expert_data['episode_starts'][i]}")
    #     if expert_data['episode_starts'][i] == 1:
    #         print(f"Episode starts i: {i}")
    #         print(f"Reward: {episode_rewards[i]}")
    #     expert_data['episode_starts'] = np.delete(expert_data['episode_starts'], i, 0)
    #
    # print(f"{find_such_row(expert_data['obs'], expert_data['actions'])}")
    # print(f"{expert_data['episode_returns']}")
    #
    # expert_data['episode_returns'] = np.delete(expert_data['episode_returns'], 0, 0)
    #
    # np.savez(f'combined_expert_data_without_ids_&_configuration', **expert_data)


    # fnames = ['/home/bch_svt/cartpole/simulation/rl/expert_data/real/without_ids_&_without_configuration/combined_expert_data_without_ids_&_configuration.npz']
    #
    # expert_data = open_expert_data(fnames)
    #
    # expert_data['obs'] = expert_data['obs'][:, :-1]
    #
    # print(f"Expert data obs: {expert_data['obs'].shape}")
    #
    # np.savez(f'combined_expert_data_without_ids_&_configuration_&_heights', **expert_data)

    fnames = ['/home/bch_svt/cartpole/simulation/rl/expert_data/real/without_ids_&_without_configuration/combined_expert_data_without_ids_&_configuration.npz']
    calculate_normalization_coefficients(fnames)
    normalize_expert_data('/home/bch_svt/cartpole/simulation/rl/expert_data/real/without_ids_&_without_configuration/combined_expert_data_without_ids_&_configuration.npz', True)
